...
You can connect to a Postgres database using the postgres module from deno.land. This example uses [sql-bricks](http://csnw.github.io/sql-bricks/) package to generate SQL queries.
