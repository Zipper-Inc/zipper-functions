...
To illustrate how the applet works, we've got a sample website below. It's hooked up to our waitlist management applet, so you can see how the two work together. You can try it out by submitting a fake email address and then visting https://clerk-waitlist.zipper.run/run.
