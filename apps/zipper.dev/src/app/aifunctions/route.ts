...
const functions: ChatGPTFunction[] = [
  {
    ...
    description: "Generates a basic typescript code that implements the user request using OpenAI",
    parameters: {
      type: "object",
      properties: {
        userRequest: {
  ...
  },
  {
    ...
    description: "Reimplementation of previous generated code but using Zipper functionalities",
    parameters: {
      type: "object",
      properties: {
        userRequest: {
        ...
        rawTypescriptCode: {
          type: "string",
          description: "The raw typescript code generated by the previous function",
        },
      },
...
async function chat({previousMessages, userRequest} : {previousMessages: ChatGPTMessage[], userRequest: string}) {
...
async function generateZipperAppletVersion({userRequest, rawTypescriptCode} : {userRequest: string, rawTypescriptCode: string}) {
