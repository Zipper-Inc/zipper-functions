...
function NotionConnectorForm({ appId }: { appId: string }) {
  ...
  const tokenName = 'NOTION_API_KEY';
  ...
  return (
    <Box px="6" w="full">
      {notionConnector && (
        <>
          <Box mb="5">
            <Heading size="md">{notionConnector.name} Connector</Heading>
          </Box>
          <VStack align="start">
            {appInfo.canUserEdit ? (
              <>
                      ...
                      <CardBody color="gray.600">
                        ...
                        >
                          ...
                          <Text mt="10" color="gray.600">
                            After saving the API key, you can use the Notion
