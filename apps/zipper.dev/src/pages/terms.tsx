    ...
    <>
      ...
      >
        <Container maxW="container.xl">
          ...
          <Text pb={5}>
            Welcome to Zipper. Please read on to learn the rules and
            ...
            and <strong>ZIPPER, INC.</strong> (“Zipper,” “we” and “us”). Your
            ...
            action waiver and resolution of disputes by arbitration instead of
            in court.{' '}
            <strong>
              LEASE NOTE THAT YOUR USE OF AND ACCESS TO OUR SERVICES ARE SUBJECT
              TO THE FOLLOWING TERMS; IF YOU DO NOT AGREE TO ALL OF THE
          ...
          <Text mb={10}>
            ...
            on our site located at{' '}
            <Link
              color="purple.500"
              href="https://zipper.works"
              target="_blank"
            >
              https://zipper.works
            </Link>
          ...
          <Text mb={10}>
            ...
            <br />
            <br />
            You agree, represent, and warrant to Zipper that if you in your use
            of our Services collect any “personal data”, “personally
            identifiable information,” “personal information,” any substantial
            equivalent of these terms, or other data regulated under any
            applicable laws (collectively, “Personal Information”), including
            Personal Information pertaining to a minor, and store such
            information within your Zipper account or upload or otherwise enable
            such information to be uploaded to the application created for you
            by Zipper, you have obtained valid consent for such activities
            according to the applicable laws of the jurisdiction in which the
            data subject lives. You further agree, represent, and warrant to
            Zipper that you will get and maintain all necessary permissions and
            valid consents required to lawfully transfer such personal
            information to Zipper and to enable such personal information to be
            lawfully collected, processed, and shared by Zipper for the purposes
            of providing the Service or as otherwise directed by you.
            <br />
            <br />
            ...
            2016/679) EU GDPR as it forms part of the law of England and Wales
            by virtue of section 3 of the European Union (Withdrawal) Act 2018
            the UK Data Protection Laws, the Swiss Federal Act on Data
            Protection, the UK Data Protection Act 2018, or any other Personal
            Information, including sensitive or special data, that might impose
            specific data security or data protection obligations on Zipper,
            including, without limitation (i) “protected health information” as
            defined under the Health Insurance Portability and Accountability
            Act of 1996 (HIPAA), (ii) “cardholder data” as defined under the
            Payment Card Industry Data Security Standard (PCI DSS), or (iii)
            “nonpublic personal information” as defined under the
            Gramm-Leach-Bliley Act of 1999, in each case as such Acts and
            standards have been or may be supplemented and amended from time to
            time (collectively, “Prohibited Data”). You hereby agree and
            acknowledge that you will not use the Services, nor permit your
          ...
          <Text mb={10}>
            ...
            children who are under 13 years of age. We do not knowingly collect
            or solicit personally identifiable information from children under
            13 years of age; if you are a child under 13 years of age, please do
            not attempt to register for or otherwise use the Services or send us
            any personal information. If we learn we have collected personal
            information from a child under 13 years of age, we will delete that
            information as quickly as possible. If you believe that a child
            under 13 years of age may have provided us personal information,
          ...
          <Text mb={10}>
            ...
            user name (“Zipper User ID”), and provide us with certain
            ...
            information about yourself. You may not select as your Zipper User
            ...
            accessible to us and may exercise such control by adjusting your
            privacy settings on your Third Party Account. <br /> <br />
            ...
            can’t and won’t be responsible for your using the Services in a way
            that breaks the law. <br /> <br />
          ...
          <Text mb={5}>
            ...
            for any purpose any Content not owned by you, (i) without the prior
            consent of the owner of that Content or (ii) in a way that violates
            someone else’s (including Zipper’s) rights.
            <br /> <br />
            ...
            written permission from us. You understand that Zipper owns the
          ...
          <Heading as="h3" fontSize="2xl" py={2}>
            ...
            grant any licenses to Zipper or to other users?
          </Heading>
          ...
          <Text mb={5}>
            ...
            and shall grant Zipper a worldwide, non-exclusive, perpetual,
          ...
          <Text mb={5}>
            ...
            original complaining party informing that person that Company may
...
7 Mount Lassen Dr, Unit 152, San Rafael, CA, 94903`}
          ...
          <Text mb={10}>
            ...
            websites or services that are not owned or controlled by Zipper.
            When you access third-party websites or use third-party services,
            you accept that there are risks in doing so, and that Zipper is not
            ...
            cannot monitor, verify, censor or edit the content of any
            ...
            third parties. You agree that Zipper shall not be responsible or
            ...
            dispute with one or more other users, you release Zipper, its
            ...
            or in any way related to such disputes and/or our Services. You
            shall and hereby do waive California Civil Code Section 1542 or any
            similar law of any jurisdiction, which says in substance: “A general
          ...
          <Text mb={10}>
            ...
            restrict access to parts or all of the Services. We’ll try to give
            you notice when we make a material change to the Services that would
            adversely affect you, but this isn’t always practical. We reserve
            the right to remove any Content from the Services at any time, for
            any reason (including, but not limited to, if someone alleges you
          ...
          <Text mb={5}>
            ...
            fee, and if you wish to continue using such Services, you must pay
            all applicable fees for such Services. Note that if you elect to
            receive text messages through the Services, data and message rates
            may apply. Any and all such charges, fees or costs are your sole
            responsibility. You should consult with your wireless carrier to
            determine what rates, charges, fees or costs may apply to your use
            of the Services.
          </Text>
          ...
          <OrderedList fontSize="sm" pl={5} mb={10}>
            {[
              <Text>
                ...
                payments now or in the future (the “Paid Services”). Please see
                our{' '}
              ...
              <Text>
                ...
                in addition to these Terms. Currently, we use Stripe, Inc. as
                our Payment Processor. You can access Stripe’s Terms of Service
                at{' '}
                <Link
                ...
                Services, you agree to pay us, through the Payment Processor,
                all charges at the prices then in effect for any use of such
                Paid Services in accordance with the applicable payment terms,
                and you authorize us, through the Payment Processor, to charge
                your chosen payment provider (your “Payment Method”). You agree
                to make payment using that selected Payment Method. We reserve
              ...
              <Text>
                ...
                However, you will not be eligible for a prorated refund of any
                portion of the subscription fee paid for the then-current
                subscription period. If you do not want to continue to be
                charged on a recurring monthly basis, you must cancel the
                applicable Paid Service BY EMAILING US{' '}
                <Link href="mailto: support@zipper.works" color="purple.500">
                  support@zipper.works
                </Link>{' '}
                ...
                provided in these terms, ZIPPER will not refund any fees that
          ...
          <Text mb={10}>
            ...
            Services. Zipper is also free to terminate (or suspend access to)
            your use of the Services or your account for any reason in our
            discretion, including your breach of these Terms. Zipper has the
            sole right to decide whether you are in violation of any of the
            restrictions set forth in these Terms. Account termination may
            result in destruction of any Content associated with your account,
            so keep that in mind before you decide to terminate your account. If
            you have deleted your account by mistake, contact us immediately at{' '}
            <Link href="mailto: support@zipper.works" color="purple.500">
              support@zipper.works
            </Link>{' '}
            - we will try to help, but unfortunately, we can’t promise that we
            can recover or restore anything. Provisions that, by their nature,
            should survive termination of these Terms shall survive termination.
            By way of example, all of the following will survive termination:
            any obligation you have to pay us or indemnify us, any limitations
            on our liability, any terms regarding ownership or intellectual
            property rights, and terms regarding disputes between us, including
            without limitation the arbitration agreement.
          </Text>
          ...
          <Text mb={10}>
            ...
            together, the “Zipper Parties”) make no representations or
            ...
            and the Zipper Parties will not be responsible or liable for the
            ...
            arising out of use of, or in any way related to your participation
            in, the Services. The Zipper Parties make no representations or
            ...
            Services. THE SERVICES AND CONTENT ARE PROVIDED BY ZIPPER (AND ITS
            LICENSORS AND SUPPLIERS) ON AN “AS-IS” BASIS, WITHOUT WARRANTIES OF
            ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, WITHOUT LIMITATION,
            IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
            PURPOSE, NON-INFRINGEMENT, OR THAT USE OF THE SERVICES WILL BE
            UNINTERRUPTED OR ERROR-FREE. SOME STATES DO NOT ALLOW LIMITATIONS ON
            ...
            THE AGGREGATE, IN EXCESS OF THE GREATER OF (I) ONE-HUNDRED ($100)
            DOLLARS OR (II) THE AMOUNTS PAID AND/OR PAYABLE BY YOU TO ZIPPER IN
            ...
            agree to indemnify and hold the Zipper Parties harmless from and
            ...
            your rights or obligations hereunder, or your Services account, in
            any way (by operation of law or otherwise) without Zipper’s prior
            ...
            under the Federal Arbitration Act, applicable federal law, and the
            ...
            disputes and claims with Zipper and limits the manner in which you
            can seek relief from Zipper. Both you and Zipper acknowledge and
            agree that for the purposes of any dispute arising out of or
            relating to the subject matter of these Terms, Zipper’s officers,
          ...
          <OrderedList fontSize="sm" pl={5} mb={10}>
            {[
              <Text>
                ...
                San Francisco. The arbitration will proceed in the English
              ...
              <Text>
                <i>Costs of Arbitration.</i> The Rules will govern payment of
                all arbitration fees. Zipper will pay all arbitration fees for
                claims less than seventy-five thousand ($75,000) dollars. Zipper
                will not seek its attorneys’ fees and costs in arbitration
                unless the arbitrator determines that your claim is frivolous.
              </Text>,
              <Text>
                <i>Small Claims Court; Infringement.</i> Either you or Zipper
                ...
                or work. Furthermore, notwithstanding the foregoing obligation
              ...
              <Text>
                ...
                between you and Zipper over whether to vacate or enforce an
                arbitration award, YOU AND ZIPPER WAIVE ALL RIGHTS TO A JURY
              ...
              <Text>
                ...
                you nor Zipper is entitled to arbitration; instead all claims
                and disputes will be resolved in a court as set forth in (g)
                below.
              </Text>,
              <Text>
                <i>Opt-out.</i> You have the right to opt out of the provisions
                of this Section by sending written notice of your decision to
                opt out to the following address: 1700 Montgomery Street, Suite
                108, San Francisco, CA, 94111 postmarked within thirty (30) days
                of first accepting these Terms. You must include (i) your name
                and residence address, (ii) the email address and/or telephone
              ...
              <Text>
                ...
                apply to either party, and both you and Zipper agree that any
                judicial proceeding (other than small claims actions) will be
                brought in the state or federal courts located in, respectively,
                San Francisco County, or the federal district in which that
                county falls.
              </Text>,
              <Text>
                <i>Severability.</i> If the prohibition against class actions
          ...
          <Text mb={10}>
            ...
            Services, provided that the Zipper may, in its sole discretion, do
            ...
            in full force and effect and enforceable. You and Zipper agree that
            these Terms are the complete and exclusive statement of the mutual
            understanding between you and Zipper, and that these Terms supersede
            and cancel all previous written and oral agreements, communications
            ...
            employee, agent, partner, or joint venture of Zipper, and you do not
            have any authority of any kind to bind Zipper in any respect
            whatsoever.
            <br />
            <br />
