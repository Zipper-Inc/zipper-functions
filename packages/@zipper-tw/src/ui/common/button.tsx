  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        'outline-primary':
          'border border-primary bg-background text-primary hover:bg-primary/10 focus:bg-primary/10',
        'outline-secondary':
          'border border-secondary bg-background text-secondary hover:bg-secondary/10 focus:bg-secondary/10',
        secondary:
